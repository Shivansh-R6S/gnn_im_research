#!/usr/bin/env python3
"""
Experiment 1 Improved (Fixed): Test Multiple GNN Architectures with Deterministic Results

This version sets random seeds to ensure reproducible results.
"""
...
def run_improved_experiment_1(dataset_path: str = "data/raw/cybercrime_edge_list.txt"):
    ...
    print("\n" + "="*70)
    print("EXPERIMENT 1 IMPROVED (DETERMINISTIC): Multiple GNN Architectures")
    print("="*70)
    ...
    print(f"\n{'='*70}")
    print("EXPERIMENT 1 IMPROVED COMPLETE (Deterministic)")
    print(f"{'='*70}\n")
